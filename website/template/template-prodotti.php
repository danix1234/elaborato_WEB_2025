                            ...
                            <div class="row py-4">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row justify-content-md-start justify-content-center mt-2 ms-0">
                                        <?php if (!$disabilitato) { ?>
                                            <button class="btn btn-danger col-auto me-4 btn-custom-lgold" id="<?php echo $item["codProdotto"] ?>">Modifica</button>
                                            <button class="btn btn-danger col-auto me-4 custom-remove-button" id="<?php echo $item["codProdotto"] ?>">Rimuovi</button>
                                        <?php } else { ?>
                                            <button class="btn btn-danger col-auto me-4 custom-remove-button" id="<?php echo $item["codProdotto"] ?>">Riabilita</button>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
