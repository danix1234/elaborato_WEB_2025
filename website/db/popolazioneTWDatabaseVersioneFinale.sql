...
(5,3,2,'Sul mio iphone precedente, la fotocamera era molto meglio','2025-01-13 22:40:36'),
(5,4,1,'meh. Niente di che','2025-01-13 22:40:55'),
(6,1,2,'Costa troppo','2025-01-13 22:44:13'),
(6,2,3,'Costa 1500 euro, ma ha solo 8GB di RAM. Se non fosse per le ARM chip, e la durata della batteria, non lo comprerei mai! Cioè un laptop con linux preinstallato, e migliori statisiche (tranne la durata della batteria), ha prezzi simili, ma prestazioni migliori!','2025-01-13 22:46:07'),
...
(8,9,5,'Sono comodi per evitare di portarsi il telefono dietro, ma avere accesso ad applicazioni utili, come la calcolatrice, o utile per tracciare il percorso e le statistiche mentre corro','2025-01-13 22:52:28'),
...
(10,2,5,'Fantastico! Ha una batteria di 14 ore, che è perfetto per me, in quanto viaggio spesso','2025-01-13 22:58:06'),
(15,2,2,'Brutto! MacOS ha molte meno funzionalità di un qualunque linux distro. L\'ho comprato perchè il mio amico Gian Giovanni me lo aveva consigliato, ma ne sono pentito! Devo ammettere, però, che ha una durata della batteria di 14 ore! Mai visto da nessuna altra parte! ','2025-01-13 23:06:08'),
...
(17,10,1,'Adoro il design. Il prezzo è un pò esagerato, però!','2025-01-13 23:07:35'),
...
(19,11,4,'Preferisco le fotocamera della Sony!','2025-01-13 23:11:00'),
